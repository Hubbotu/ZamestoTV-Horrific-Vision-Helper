...
local function CreateProgressBar(index, name, total, isCrystal)
    ...
    nameText:SetFont("Interface\\AddOns\\"..addonName.."\\front.ttf", 16, "OUTLINE")
    nameText:SetText(name)
    
    local valueText = frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    valueText:SetPoint("CENTER", frame, "CENTER", 0, 0)
    valueText:SetTextColor(1, 1, 1, 1)
    valueText:SetFont("Interface\\AddOns\\"..addonName.."\\front.ttf", 18, "OUTLINE")
    ...
    iconText:SetFont("Interface\\AddOns\\"..addonName.."\\front.ttf", 28, "OUTLINE")
