...
L["Wolf Tack Note"] = "需装备|cFF0070DD至少1个面具，|r。拾取物品（位于主帐篷建筑旁边，虚狂巨兽后面。）。|cFFa335ee虚痕狼母的缰绳|r"
