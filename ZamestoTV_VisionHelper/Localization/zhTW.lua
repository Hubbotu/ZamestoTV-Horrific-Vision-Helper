...
L["Magic-Lined Manifold"] = "|cFFFFFFFF魔法內襯集管|r"
L["Magic-Lined Manifold Note"] = "|cFFDC143C死亡循環排氣系統:|r 在拍賣行入口附近拾取箱子，需裝備至少1個面具。|cFFa335ee魔能掠奪者死亡循環|r"
L["Trash"] = "|cFFFFFFFF廢料|r"
L["Trash Note"] = "|cFFDC143C築巢的群聚蟲:|r 有概率召喚稀有怪物。|cFFa335ee築巢的群聚蟲|r"
L["Black Blood Bar"] = "|cFFFFFFFF黑血錠|r"
L["Black Blood Bar Note"] = "|cFFDC143C黑血灌注之錠:|r 制造|cFFa335ee虛無水晶獵豹|r的原料"
L["Ripped Note"] = "|cFFFFFFFF虛痕獅鷲的韁繩|r"
L["Ripped Note Note"] = "你必須有至少|cFFDC143C2個啟用的面具|r。\n\n擊殺審判官達克斯比，然後在樓梯上閱讀“被撕破的便箋”提供的線索，接著在牆上閱讀另一個線索（會提示食物是生的還是熟的）R - 生食 C - 熟食。\n\n1. 挑食的家伙只想吃魚 - |cFF0070DD1x鮮魚片（生） 1x串燒魚片（熟）|r\n\n2. 挑食的家伙只想吃菌類 - |cFF0070DD1x被斬斷的菌絲花（生） 1x炙烤菌絲花（熟）|r\n\n3. 挑食的家伙只想吃香料腌制的肉 - |cFF0070DD1x香肉貯藏（生） 1x樸素燉煮（熟）|r\n\n4. 挑食的家伙只想吃牛排 - |cFF0070DD1x分切的肉排（生） 1x未風干的野地肉排（熟）|r\n\n將所需食物放入“布滿爪痕的碗”並選擇“搖晃食盆”。|cFFa335ee虛痕獅鷲的韁繩|r"
L["Big Keech"] = "|cFFFFFFFF大塊頭齊奇|r"
L["Big Keech Note"] = "掉落|cFF0070DD虛空束縛神秘寶珠|r(全員)和|cFF0070DD圖鑒：虛無水晶獵豹|r(珠寶匠專有)，用於製造|cFFa335ee虛無水晶獵豹|r"
...
L["Gain"] = "|cFFFFFFFF熊之精魂|r"
L["Gain Note"] = "提高加速 10%。"
L["Gain 2"] = "|cFFFFFFFF需要壁壘|r"
L["Gain 2 Note"] = "提高臨機應變 7%。"
L["Gain 3"] = "|cFFFFFFFF賦能|r"
L["Gain 3 Note"] = "造成傷害提高 10%。"
L["Gain 4"] = "|cFFFFFFFF充實|r"
