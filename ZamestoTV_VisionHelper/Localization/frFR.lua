...
L["Ripped Note Note"] = "Vous devez avoir au moins |cFFDC143C2 masques actifs|r.\n\nTuez l'inquisiteur Darkspeak, puis lisez l'indice écrit sur la Note déchirée en haut des escaliers, lire un autre sur le mur (il indiquera si la nourriture est crue ou cuite) C - cru et B - cuit.\n\n1. On dirait que cette créature difficile ne veut manger que du poisson. - |cFF0070DD1x Filet frais Filet frais (C) 1x Filet à la broche (B)|r.\n\n2. On dirait qu'il ne veut manger que des champignons. - |cFF0070DD1x Champifleur émincé Champifleur émincé (C) 1x Champifleur rôti (B)|r.\n\n3. On dirait qu'il ne veut manger que de la viande épicée. - |cFF0070DD1x Bouillon de viande épicé Bouillon de viande épicé (C) 1x Ragoût simple (B)|r.\n\n4. On dirait qu'il ne veut manger que du steak. - |cFF0070DD1x Pièce de viande Pièce de viande (C) 1x Filet sans assaisonnement (B)|r.\n\nPlacez l'aliment souhaité dans le Bol couvert de traces de griffures et agitez-le. |cFFa335eeRênes de griffon marqué par le Vide|r"
...
L["Gain 2 Note"] = "Polyvalence augmentée de 7%."
L["Gain 3"] = "|cFFFFFFFFSurpuissant|r"
